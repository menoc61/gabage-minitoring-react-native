...
const dustbinLocation = {
  latitude: order.Dustbin.lat,
  longitude: order.Dustbin.lng,
};
    ...
    <View style={styles.container}>
      ...
      >
        <MapViewDirections
          ...
          strokeColor="#3FC060"
          apikey={ "AIzaSyDw7ghdAAuXvukSBSqpc3WrdxGFhmhcfP4"}
          onReady={(result) => {
        ...
        <Marker
          ...
          title={order.Dustbin.name}
          description={order.Dustbin.address}
        >
          <View
      ...
      >
        ...
        <View style={styles.deliveryDetailsContainer}>
          <Text style={styles.restaurantName}>{order.Dustbin.name}</Text>
          <View style={styles.adressContainer}>
            <Fontisto name="shopping-store" size={22} color="grey" />
            <Text style={styles.adressText}>{order.Dustbin.address}</Text>
          </View>
